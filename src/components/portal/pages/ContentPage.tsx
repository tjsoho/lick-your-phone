  ...
  if (slug === "cover") {
    return (
      <div className="flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        {page.featuredImage && (
          <div className="mb-10 overflow-hidden rounded-2xl border border-lyp-white/10 shadow-xl">
            <Image
    ...
    <div className="flex h-full flex-col overflow-y-auto">
      <div className="flex-1 flex flex-col justify-center px-8 py-12 md:px-16 lg:px-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          {page.featuredImage && page.imagePosition === "left" && (
          ...
          {page.featuredImage && page.imagePosition === "right" && (
            <div className="lg:col-span-5 relative">
              <div className="sticky top-10 overflow-hidden rounded-2xl border border-lyp-white/10 shadow-xl">
                <Image
                  src={page.featuredImage}
